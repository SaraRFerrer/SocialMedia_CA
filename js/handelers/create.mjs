...
export async function getPosts() {
    const response = await fetch(`${API_PATH_URL}${action}/?_author=true&limit=100`, {
        method: 'get',
        headers: {
    ...
    bg-white border mt-2 height=100%">
    <div class="d-flex flex-row justify-content-between align-items-center p-2 border-bottom">
    <p class="d-flex justify-content-end socials">${userPost.author.name}</p></div>
    <div class="d-flex flex-row justify-content-between align-items-center p-2 border-bottom">
